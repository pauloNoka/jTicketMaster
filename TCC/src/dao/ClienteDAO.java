...
public class ClienteDAO {
	...
	public void update(Cliente cliente){
		...
		String sql = "UPDATE TKClientes SET"
				+ "(CliLogin = ?, CliNome = ?, CliSexo = ?, CliNascimento = ?, CliCpf = ?, CliCnpj = ?, CliRg = ?, CliTelefone = ?, CliCelular = ?, CliEndereco = ?, CliNumeroEndereco = ?, CliBairro = ?, IdEstado = ?, IdCidade = ?, CliEmail = ?, CliSenha = ?)";
		...
		try {
			...
			stmt.setInt(11, cliente.getCliNumeroEndereco());
			stmt.setString(12, cliente.getCliBairro());
			stmt.setInt(14, cliente.getIdCidade());
			stmt.setString(15, cliente.getCliEmail());
			stmt.setString(16, cliente.getCliSenha());
