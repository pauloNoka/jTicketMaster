					          ...
					          <div class="span6">
					            ...
					            <div class="vpadded">
									  ...
									  <div class="input full-width">
									    <input type="text" name="NomeProduto" placeholder="Nome Completo">
									  </div>
									  ...
									  <div class="input full-width">
									    <input type="text" name="SiglaProduto" placeholder="Sigra do Produto">
									  </div>
									  
									  <div class="input full-width">
									    <textarea name="DescricaoProduto" placeholder="Descri��o do Produto"></textarea>
									  </div>
									  
									  <div class="input full-width">
									    <input type="file" name="IMGProduto" placeholder="Imagem do Produto">
									  </div>		  
